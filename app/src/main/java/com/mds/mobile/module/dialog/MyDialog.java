package com.mds.mobile.module.dialog;
...
public class MyDialog {
    ...
    public static final int DIALOG_ID_CLOSE = 0x1010;
...
//            dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
    ...
    public static void showDialogSucceed(Context context, final int intDialogId,
                                      String title, String content,
                                      final String btnText, final IMyDialog iMyDialog) {
        dialogDismiss();
        Button btnMid = null;
