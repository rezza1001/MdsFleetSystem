...
public class ClientChangePasswordActivity extends ClientBaseUi {
    ...
    protected int getContentViewId() {
        return R.layout.activity_client_change_password;
    }
    ...
    public void showAlertDialogSaveClicked() {
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Loading.showLoading(ClientChangePasswordActivity.this, "Loading ...");
                callJSONChangePassword();
            }
        });
