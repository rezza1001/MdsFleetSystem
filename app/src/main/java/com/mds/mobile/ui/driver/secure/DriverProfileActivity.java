...
public class DriverProfileActivity extends DriverBaseUi {
...
//            tvContact.setText(data.getContactPerson());
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btn_change_password) {
            startActivity(new Intent(getApplicationContext(), DriverChangePasswordActivity.class));
...
//        Intent intent = new Intent(DriverProfileActivity.this, ImagePickerActivity.class);
