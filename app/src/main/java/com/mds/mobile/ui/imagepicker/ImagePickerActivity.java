                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            ...
                            fileName = generateRandomAlpha() + ".jpg";
...
//        super.onActivityResult(requestCode, resultCode, data);
    ...
    private void cropImage(Uri sourceUri) {
        ...
        MyLog.info("sourceUri "+sourceUri);
        MyLog.info("destinationUri "+destinationUri);
...
//    String currentPhotoPath;
    ...
    private Uri getCacheImagePath(String fileName) {
        File path = new File(getExternalFilesDir(null), "camera");
        if (!path.exists()) path.mkdirs();
        File image = new File(path, fileName);

//        currentPhotoPath = "file:" + image.getAbsolutePath(); //image.getAbsolutePath();

//        return getUriForFile(ImagePickerActivity.this, getPackageName() + ".provider", image);
        return getUriForFile(ImagePickerActivity.this, "com.mds.mobile.fileprovider", image);
    ...
    public static void clearCache(Context context) {
        File path = new File(context.getExternalFilesDir(null), "camera");
