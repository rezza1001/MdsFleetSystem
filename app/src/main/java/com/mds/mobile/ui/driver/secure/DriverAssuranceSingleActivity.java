...
public class DriverAssuranceSingleActivity extends DriverAssuranceBaseActivity {
    ...
    Bitmap bmpKendaraan1=null;
    Bitmap bmpKendaraan2=null;
    Bitmap bmpKendaraan3=null;
    Bitmap bmpSimPengendara=null;
    Bitmap bmpStnk=null;
    Bitmap bmpNoRangka=null;

    @Override
    protected int getContentViewId() {
        return R.layout.activity_driver_assurance_single;
    }
    ...
    public void showAlertDialogSaveClicked() {
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (dialog != null) dialog.dismiss();
                Loading.showLoading(DriverAssuranceSingleActivity.this, "Loading ...");
