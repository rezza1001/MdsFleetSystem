...
public class DriverAssuranceForceNatureActivity extends DriverAssuranceBaseActivity {
    ...
    protected int getContentViewId() {
        return R.layout.activity_driver_assurance_force_nature;
    }
    ...
    public void showAlertDialogSaveClicked() {
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (dialog != null) dialog.dismiss();
                Loading.showLoading(DriverAssuranceForceNatureActivity.this, "Loading ...");
