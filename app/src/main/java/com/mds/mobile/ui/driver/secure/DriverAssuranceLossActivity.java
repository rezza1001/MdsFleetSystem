...
public class DriverAssuranceLossActivity extends DriverAssuranceBaseActivity {
    ...
    protected int getContentViewId() {
        return R.layout.activity_driver_assurance_loss;
    }
    ...
    protected void onMyCreate() {
        ...
        etKehilangan = findViewById(R.id.et_loss_part);
    ...
    private boolean isValid() {
        ...
        if (GlobalHelper.isEmpty(etKehilangan.getText().toString())) {

            MyDialog.showDialog1Btn(this, MyDialog.DIALOG_ID_ALERT, getString(R.string.title_assuranceclaim),
                    "Komponen yang hilang/rusak harus diisi.", getString(R.string.ok), this);

            etKehilangan.requestFocus();
            return false;
        }
    ...
    public void showAlertDialogSaveClicked() {
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (dialog != null) dialog.dismiss();
                Loading.showLoading(DriverAssuranceLossActivity.this, "Loading ...");
...
//                callJSONAddFleetInsurance();
    ...
    private void callJSONAddFleetInsurance() {
        ...
        // todo. hardcode dulu
        ent.setClaimType("Kehilangan/Pengrusakan");
...
//        yyyy-MM-dd HH:mm:ss
        ...
        ent.setIncidentLocation("-");
        ent.setIncidentSpeed("-");
        ent.setDamageDescription(etKehilangan.getText().toString());
